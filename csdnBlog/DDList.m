...
@synthesize _searchText, _selectedText, _resultList, _delegate,_totalList;
...
- (void)updateData {
    ...
    {
        if([[_totalList objectAtIndex:i] rangeOfString:_searchText].location !=NSNotFound)//_roaldSearchText
        {
            [_resultList addObject:[NSString stringWithFormat:@"%@",[_totalList objectAtIndex:i]]];
        }
	}
